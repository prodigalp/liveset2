...
<html lang="en-US">
    ...
    <body>
        <div id="wrapper">
            ...
            Eum tenetur similique excepturi quis incid unt. Accusantium tempora consectetur excepturi sequi incidunt? Modi perspiciatis deserunt amet corporis nobis facilis ullam commodi veritatis dolores, iusto doloribus molestias est esse, eos reprehenderit.</p>
            <footer>Copyright 2022</footer>
            <div class="triColumn">
                <div class="colOne">
                    <h2>Column One</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis tempora, quibusdam incidunt ut quisquam aut omnis sit sed assumenda ab soluta autem. Unde cupiditate quos nam perspiciatis quasi vero? Qui.</p>
                </div>
                <div class="colTwo">
                    <h2>Column Two</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam eveniet voluptates hic fugit dolore ab corrupti! Tempore consequatur assumenda totam natus, deserunt officiis harum amet ipsa provident! Labore, aut voluptatem?</p>
                </div>
                <div class="colTri">
                    <h2>Column Three</h2>
